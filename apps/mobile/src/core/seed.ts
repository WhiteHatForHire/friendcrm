...
export const seedPeople: Person[] = [
  {
    ...
    contactMethods: [{ type: "signal", value: "Claire" }],
    importance: 5,
    warmth: "warm",
    trust: 5,
  ...
  },
  {
    ...
    contactMethods: [{ type: "email", value: "maya@example.com" }],
    importance: 4,
    warmth: "warm",
    trust: 4,
    strategicRelevance: 5,
  ...
  },
  {
    ...
    contactMethods: [{ type: "whatsapp", value: "Lauren" }],
    importance: 5,
    warmth: "warm",
    trust: 5,
  ...
  },
  {
    ...
    city: "Seattle",
    timezone: "America/Los_Angeles",
    contactMethods: [{ type: "email", value: "evan@example.com" }],
    importance: 3,
    warmth: "cool",
    trust: 3,
    strategicRelevance: 4,
...
export const seedNotes: RelationshipNote[] = [
  {
    ...
    sourceType: "call",
    rawText: "Claire is exploring a small advisory group and asked for two founder intros. Promised to send names by Friday. She prefers a tight memo before calls.",
    sensitivity: "normal",
    createdAt: daysAgo(9)
  },
  {
  ...
  },
  {
    ...
    sourceType: "call",
    rawText: "Maya can introduce me to two community operators if I send a one-paragraph context note. Follow up this week.",
    sensitivity: "normal",
  ...
  },
  {
    ...
    sourceType: "call",
    rawText: "Lauren said the last conversation helped. Do not turn this into a project. Send a small check-in and ask about the garden.",
    sensitivity: "private",
...
export const seedOpenLoops: OpenLoop[] = [
  {
    ...
    description: "Claire asked for names for her advisory group.",
    dueAt: daysAgo(3),
    sensitivity: "normal",
    status: "open"
  },
...
export const seedNextMoves: NextMove[] = [
  {
    ...
    personId: "p-ada",
    type: "intro",
    draft: "Send Claire a short note with two founder names and why each might fit her advisory group.",
